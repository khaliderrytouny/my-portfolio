  ...
  return (
    ...
    >
      <div className="flex flex-wrap">
        ...
        >
          <h1 className="pb-1 text-4xl font-thin tracking-tight lg:mt-5 lg:text-6xl">KHALID ER-RYTOUNY</h1>
          <motion.span
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
           I am a skilled full stack software developer with two years of hands-on experience and a digital development certificate obtained this year. I have worked with a variety of companies, gaining expertise in a range of technologies including React.js, Node.js, Laravel, MongoDB, MySQL, Bootstrap, and Tailwind. My focus is on crafting robust and scalable web applications. I am passionate about using my skills to create innovative solutions that enhance business growth and deliver exceptional user experiences.
          </motion.p>
        </motion.div>
        <motion.div
